...
e_fnacimiento = DateEntry(frame_datos, width=15, justify='center', date_pattern="dd-mm-yyyy",textvariable=var_fnacimiento)
e_fnacimiento.grid(row=5, column=1)
e_falta = DateEntry(frame_datos, width=15, justify='center', date_pattern="dd-mm-yyyy",textvariable=var_falta)
