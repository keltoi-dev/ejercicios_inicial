...
def update_treeview(mitreview, parameter = ""):
    if not parameter:
        ...
        sql = "SELECT id, dni, nombres, apellidos, obra, jornal from empleados WHERE obra='" + parameter + "';"
...
btn_cerrar = Button(frame_menu, text= "CERRAR", width= 15, command= lambda: window.destroy())
